...
class AlienInvasion:
	...
	def _check_events(self):
		...
		for event in pygame.event.get():
			if event.type == pygame.QUIT:
				...
				self._chceck_keyup_events(event)
	...
	def _chceck_keyup_events(self,event):
	...
	def _update_bullets(self):
		"""Uaktualnienie położenia pocisków i usunięcie tych nie widocznych na ekranie."""
		#Uaktualnienei położenia pocisków
		self.bullets.update()

		#Usunięcie pocisków niewidocznych na ekranie
	...
	def _update_aliens(self):
		...
		"""
		Sprawdzenie czy flota znajduje się przy krawędzi, a 
